        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          {data.map((step, i) => (
            <div key={i} className="relative text-center">
              ...
              <div className="absolute -top-2 -right-2 md:right-auto md:left-[calc(50%+16px)] w-7 h-7 rounded-full bg-blue-500 text-white text-xs font-bold flex items-center justify-center">
                {steps[i].number}
              </div>
